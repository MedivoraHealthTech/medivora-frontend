...
export default function AdminLayout() {
  ...
  return (
    <div style={{
      ...
      {!isMobile && (
        <aside style={{
          width: SIDEBAR_W, background: '#0A1B47', color: '#fff',
      ...
      <main style={{
        ...
        {isMobile && (
          <div style={{
            ...
            padding: '12px 16px', background: '#0A1B47',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <Logo size={24} />
              <span style={{ fontSize: 13, fontWeight: 800, color: '#fff', letterSpacing: 0.3 }}>Medivora Admin</span>
            </div>
          </div>
        )}

        <div style={{ padding: isMobile ? '16px' : '2rem', flex: 1 }}>
          <Outlet />
        </div>
      </main>
    </div>
